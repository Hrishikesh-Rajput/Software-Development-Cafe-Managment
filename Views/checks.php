...
<html>
    ...
    <div id="loader" class="loader">
        <div id="team">BY <i class="fa fa-heart"></i> Om Pardeshi </div>
    </div>
                                    ...
                                    <tbody id="accordion">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $order['total_price'] ?> INR
                                                </td>
                                            </tr>
                                                                ...
                                                                <div class="card">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <p class="card-text">
                                                                            ...
                                                                            echo $product['product_amount'] . ' x ' . $product['product_name'] . '<br> Total : ' . $price . ' INR';
                                                                            ?>
                                                                        </p>
                                                                    </div>
                                                                </div>
