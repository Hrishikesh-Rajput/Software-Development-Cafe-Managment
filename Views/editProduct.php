...
<html>
<head>
    <title>Cafe Marvelous | Edit Product</title>
            ...
            <form class="login-form" action="../Controller/productController.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <select  class="form-input" name="category" required>
                        ...
                        <option value="Pizza" <?php if($product['category']=="Pizza") echo 'selected="selected"'; ?> >Pizza</option>
                        <option value="Burger" <?php if($product['category']=="Burger") echo 'selected="selected"'; ?> >Burger</option>
                        <option value="Fries" <?php if($product['category']=="Fries") echo 'selected="selected"'; ?> >Fries</option>                    
                        <option value="Spagetti" <?php if($product['category']=="Spagetti") echo 'selected="selected"'; ?> >Spagetti</option>                    
                    </select>
                </div>
